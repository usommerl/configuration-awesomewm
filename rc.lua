...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag(tagNames(9), s, awful.layout.suit.tile)
end
-- }}}
...
vicious.register(wifiWidget, vicious.widgets.wifi, '${linp}', 15, "wlp4s0")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({},                    "#122",   function () awful.util.spawn_with_shell("amixer -c 1 --quiet set Master 1%-") end),
    awful.key({ modkey},             "-",      function () awful.util.spawn_with_shell("amixer -c 1 --quiet set Master 1%-") end),
    awful.key({},                    "#123",   function () awful.util.spawn_with_shell("amixer -c 1 --quiet set Master 1%+") end),
    awful.key({ modkey},             "+",      function () awful.util.spawn_with_shell("amixer -c 1 --quiet set Master 1%+") end),
